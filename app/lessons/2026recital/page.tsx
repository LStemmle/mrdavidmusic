    ...
    <>
      ...
      <div className="intro">
        ...
        <div className="intro-body">
          ...
          <p>A specific thanks to Julian Brown, who has been the bass teacher these last six months. He has done an amazing job, and you will see that tonight! Thanks to Sammy for dress rehearsal pizza! Thanks to Sarah Harlan aka &quot;The Gatekeeper&quot; for her stage management / cat herding magic. Thanks to Misha Angrist for supporting and participating with this studio for over a decade! Thanks to Julie Daniels for making the video recording of these performances — watching those videos is one of my favorite things to do after the recital is over. Thanks to Jonathan for his level tweaking and sub singing. And thanks to Ed Hurt for fixing my guitars when I break them. Thanks to Blade Addison for partnering in Bullseye Music at <a href="https://mrdavidmusic.com/used-gear" target="_blank" rel="noopener noreferrer">Classic Treasures</a>. Thanks to Chris Rossi and DUSKY Electronics for allowing us to use his amazing new amplifier — the amp is in preproduction and they are taking orders now at <a href="https://duskyamp.com/models/" target="_blank" rel="noopener noreferrer">duskyamp.com</a>. And thanks to my wonderful family / house band: Laura, Nate, and Ben!</p>
        </div>
